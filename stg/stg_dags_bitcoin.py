...
dag = DAG(
    dag_id='stg_dags_bitcoin_price',  # Update to stg/prd for respective environments
...
slack_webhook_url = "https://hooks.slack.com/services/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"  # Replace with your webhook URL
